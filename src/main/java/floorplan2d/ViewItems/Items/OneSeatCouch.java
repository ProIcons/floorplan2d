 ...
 * @author Nikolas
 */
public class OneSeatCouch extends DecorationItem implements java.io.Serializable {
    private static String name = "One Seat Couch";
    public static String getItemName() {
        return name;
    }
    public OneSeatCouch(View c) {
        this(new Point2D.Double(0,0),c);
    }
    public OneSeatCouch(Point2D.Double pos, View c) {
        super("One Seat Couch", pos, new Dimension(70, 70), c);
        isResizeable = false;
        typeName = "OneSeatCouch";
    }
    ...
    public DecorationItem clone() {
        OneSeatCouch temp = new OneSeatCouch(new Point2D.Double(position.x, position.y), view);
